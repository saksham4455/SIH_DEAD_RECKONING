...
class DemoNavigationRepository {
  const DemoNavigationRepository();

  DashboardDataModel get current => demoNavigationData;
}

final demoNavigationData = DashboardDataModel(
