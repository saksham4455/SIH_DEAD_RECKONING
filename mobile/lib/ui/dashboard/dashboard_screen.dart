        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text(
                          'FUSION CONF',
                          style: TextStyle(color: AppColors.textMuted, fontSize: 8, fontWeight: FontWeight.bold),
                        ),
                        Text(
                          '$confidencePercent%',
              ...
              const Text(
                'NAVIGATION SURFACE',
                style: TextStyle(color: AppColors.textPrimary, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1.0),
              ),
              const Text(
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text(
                    ...
                    style: TextStyle(color: AppColors.cyan, fontWeight: FontWeight.bold, letterSpacing: 1.2),
                  ),
